...
export function animateSceneInfo(sceneInfo) {
    let displacementX = -1 * ((mouseX / window.innerWidth) * 2 - 1);
    let displacementY = ((mouseY / window.innerHeight) * 2 - 1);

    sceneInfo.cube.position.x = displacementX * DISPLACEMENT_MAX;
    sceneInfo.cube.position.y = displacementY * DISPLACEMENT_MAX;
